...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('stored_original_path', sa.String(length=500), nullable=True),
        sa.Column('stored_chinapost_path', sa.String(length=500), nullable=True),
        sa.Column('stored_cbd_path', sa.String(length=500), nullable=True),
